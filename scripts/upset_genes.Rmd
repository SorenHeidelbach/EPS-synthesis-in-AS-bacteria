...
# Title of pdf
pdf_title <- "/UpSet_cellulose_1_and_2.pdf"
...
for (fil in psiblast_subset_files) {
  psiblast_subset <- rbind(psiblast_subset, read_tsv(paste0(d.dir, "/psiblast_subset_tsv/", fil)))
}
...
pdf(paste0(d.dir, pdf_title), width = 8, height = 6)
