...
get_subset_tsv <- function(dir_path=paste0(d.pro, "/psiblast_subset_tsv/")){
...
pdf(paste0(f.dir, "/UpSet_operon_shared_by_queries_simple_nulO3_eps_3.pdf"), width = 8, height = 12)
UpSetR::upset(
  upset_df,
